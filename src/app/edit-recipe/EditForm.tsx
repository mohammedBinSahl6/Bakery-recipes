...
const EditForm = ({ recipe }: { recipe: Recipe }) => {
  ...
  if (!session) {
    return (
      <div className="text-center mt-8">Please sign in to edit a recipe.</div>
    );
  }

  return (
    <div className="container">
      <h1 className="text-4xl font-bold text-center mb-10">Edit your Recipe</h1>
      <Image
        width={150}
        height={150}
      ...
      <Form {...form}>
        <form
          ...
          className="space-y-8 px-10 mx-auto bg-white p-8 rounded-lg shadow-md"
        >
          <FormField
          ...
          >
            {form.formState.isSubmitting ? "Editing Recipe..." : "Edit Recipe"}
          </Button>
        </form>
      </Form>
    </div>
